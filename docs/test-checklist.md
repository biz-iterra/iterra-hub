...
| Gate 3-2 システム (03〜07 該当章) | 2026-08-04 | Claude | E2E で代替 | LD-23〜27 を追加。手動実施は未 |
| Gate 3-3 E2E スモーク (08 ランク S) | 2026-08-04 | Claude | 通過 | **5 本全緑**。ただし最初の実行で 2 本が落ちた（下記） |
| Gate 4 受入 (09) | — | — | 未実施 | — |
...
- `08-e2e-scenarios.md` 後片付けの順序を実行方式の表に追加
